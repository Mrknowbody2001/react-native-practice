        ...
        >
          ...
          <AppSaveView style={styles.container}>
            ...
            <AppText style={styles.paragraph}>
              We've sent a 4-digit verification code to your phone. Enter the
          ...
          <View style={styles.bottomContainer}>
              <AppText style={styles.bottomText}>Didn’t receive the code?</AppText>
              <TouchableOpacity onPress={handleResendOTp}>
                <AppText  style={styles.resendBtn}>Resend code</AppText>
              </TouchableOpacity>
            </View>
           </AppSaveView>
        </ScrollView>
